...
import { LogOut, LayoutDashboard, User as UserIcon, ShieldCheck, Sparkles, AlertTriangle } from 'lucide-react'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 gap-4">
          ...
          <nav className="flex items-center space-x-3">
            ...
            <Link
              href="/businesses/new"
              className="hidden sm:inline-flex items-center space-x-1 text-xs font-semibold text-emerald-600 dark:text-emerald-400 bg-emerald-500/10 hover:bg-emerald-500/20 px-3 py-1.5 rounded-xl border border-emerald-500/20 transition duration-150"
            >
            ...
            {bdappsUser && bdappsUser.subscriptionStatus === 'REGISTERED' ? (
              <div className="relative">
                ...
                >
                  ...
                  <span className="hidden sm:inline text-xs font-semibold text-emerald-600 dark:text-emerald-400 pr-1">
                    {bdappsUser.phone}
                  </span>
                </button>
                  ...
                  <div className="absolute right-0 mt-2 w-56 rounded-2xl bg-[var(--color-surface)] border border-[var(--color-border)] shadow-xl py-2 text-sm text-[var(--color-text-primary)] animate-in fade-in slide-in-from-top-2 duration-150">
                    <div className="px-4 py-2 border-b border-[var(--color-border)]">
                      <p className="font-semibold text-[11px] uppercase tracking-wider text-emerald-600 dark:text-emerald-400 flex items-center gap-1">
                        ...
                        <span>bdapps Paid Subscriber</span>
                      </p>
              ...
              <div className="flex items-center space-x-2">
                <button
                  ...
                  className="px-4 py-2 text-xs font-bold text-white bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 rounded-full transition duration-150 shadow-md flex items-center gap-1.5"
                >
